    ...
    return (
        <div className="flex flex-col flex-1">
            ...
            <form className="space-y-4 flex-1" onSubmit={handleSubmit}>
                ...
                {/* Role Selector — shown on both login & signup */}
                <div className="space-y-3 pt-2">
                    <p className="text-[11px] font-bold text-[#6f7a74] uppercase tracking-wider ml-1">
                        {activeTab === 'signup' ? 'Select your path' : 'Log in as'}
                    </p>

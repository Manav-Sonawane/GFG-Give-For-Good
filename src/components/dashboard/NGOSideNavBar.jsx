...
export function NGOSideNavBar() {
    const pathname = usePathname();

    const navItems = [
        { name: 'Dashboard', href: '/ngo-dashboard', icon: 'dashboard' },
        { name: 'My Requirements', href: '/post-a-requirement', icon: 'format_list_bulleted' },
    ...
    return (
        <aside className="h-screen w-[220px] fixed left-0 top-0 z-40 bg-surface-container-low flex flex-col pt-4 pb-10 px-0">
            <Link href="/ngo-dashboard" className="px-6 flex items-center mb-8 transition-transform hover:scale-105">
            ...
            <div className="mb-10 px-6">
                ...
                <p className="font-['Inter'] font-medium text-sm text-primary">Global Relief Network</p>
            </div>
            ...
            <div className="mt-auto px-6 space-y-4">
                <Link
                    ...
                    className="block w-full bg-primary text-on-primary py-2 px-4 rounded-lg font-medium text-sm transition-all active:opacity-80 scale-95 hover:bg-primary-container text-center"
                >
                    Post a Requirement
                </Link>
                <div className="pt-6 space-y-3">
                    ...
                    <a className="text-slate-600 flex items-center gap-3 text-sm hover:text-primary transition-colors" href="/login">
